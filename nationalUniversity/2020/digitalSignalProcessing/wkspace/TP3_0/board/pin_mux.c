...
- pin_list:
  ...
  - {pin_num: '38', peripheral: GPIOA, signal: 'GPIO, 4', pin_signal: PTA4/LLWU_P3/FTM0_CH1/NMI_b/EZP_CS_b, direction: INPUT, gpio_interrupt: kPORT_InterruptFallingEdge,
    slew_rate: fast, open_drain: disable, drive_strength: low, pull_select: up, pull_enable: enable, passive_filter: enable}
...
void BOARD_InitButtonsPins(void)
{
    ...
    PORT_SetPinInterruptConfig(BOARD_ADC0_SE12_PORT, BOARD_ADC0_SE12_PIN, kPORT_InterruptFallingEdge);
 ...
 * TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
PINSFUNC_InitSystem:
- options: {callFromInitBoot: 'false', prefix: PINSFUNC_, coreID: core0, enableClock: 'true'}
- pin_list: []
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : PINSFUNC_InitSystem
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
void PINSFUNC_InitSystem(void)
{
}
/***********************************************************************************************************************
 * EOF
